...
__decorate([
    (0, typeorm_1.OneToOne)(() => Lecturer_1.Lecturer, (lecturer) => lecturer.user),
    __metadata("design:type", Lecturer_1.Lecturer)
], User.prototype, "lecturer", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => Candidate_1.Candidate, (candidate) => candidate.user),
    __metadata("design:type", Candidate_1.Candidate)
], User.prototype, "candidate", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => Admin_1.Admin, (admin) => admin.user),
